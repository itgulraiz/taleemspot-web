...
const staticData = [
  {
    ...
    year: "2024",
    type: "Notes",
    url: "https://drive.google.com/uc?export=download&id=1p6G83N3CbAiwR crédito: 1p6G83N3CbAiwR8T_A4Q2nwDSdfa_yR9e",
  ...
  useEffect(() => {
    if (id) {
      ...
      setTimeout(() => {
        ...
        const foundResource = staticData.find(item => item.id === parsedId);
        if (foundResource) {
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
              ...
              <div className="my-4">
                <ins 
                  ...
                  style={{ display: 'block' }}
                  data-ad-client="ca-pub-1926773803487692"
                  data-ad-slot="resource-top-banner"
              ...
              <div className="my-4">
                <ins 
                  ...
                  style={{ display: 'block' }}
                  data-ad-client="ca-pub-1926773803487692"
                  data-ad-slot="resource-bottom-banner"
                  data-ad-format="horizontal"
                  data-full-width-responsive="true"
                />
              </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="my-4">
              <ins 
                ...
                style={{ display: 'block' }}
                data-ad-client="ca-pub-1926773803487692"
                data-ad-slot="resource-sidebar-banner"
